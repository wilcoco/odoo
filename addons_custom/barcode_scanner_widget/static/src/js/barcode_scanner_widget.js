...
odoo.define('barcode_scanner_widget.custom_webcam_scanner', function (require) {
    "use strict";
    ...
    function hasHtml5Qrcode(){ return typeof Html5Qrcode !== 'undefined'; }
    function hasQuagga(){ return typeof Quagga !== 'undefined'; }
    ...
    let BarcodeScannerWidget = FieldChar.extend({
        ...
        _scan_code: function(){
            if (this.device_uid === ''){
                this.do_warn(_t("Aborting"), _t("No camera devices available"));
            }else{
                const self = this;
                ...
                if (this.code_type == 1){
                    if (!hasQuagga()){
                        this.$("#webcam_viewport").hide();
                        this.do_warn(_t("Barcode library missing"), _t("Quagga is not loaded. Add quagga.min.js to assets or use a hardware scanner."));
                        return;
                    }
                    ...
                    if (!hasHtml5Qrcode()){
                        this.$("#webcam_viewport").hide();
                        this.do_warn(_t("QR library missing"), _t("Html5Qrcode is not loaded. Add html5-qrcode.min.js to assets or use a hardware scanner."));
                        return;
                    }
        ...
        _get_user_config: function (){
            ...
            Html5Qrcode.getCameras().then(function(devices){
                ...
                self.do_warn(_t("Camera Not Found"), err);
            });
        },
