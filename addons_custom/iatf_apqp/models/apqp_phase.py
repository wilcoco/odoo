...
class IatfApqpPhase(models.Model):
    ...
    deliverable_count = fields.Integer(compute="_compute_deliverable_stats", store=True, compute_sudo=True)
    deliverable_done_count = fields.Integer(compute="_compute_deliverable_stats", store=True, compute_sudo=True)
